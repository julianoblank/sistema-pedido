...
import com.julianoblank.sistemapedido.dto.ClienteNewDTO;
...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<ClienteDTO> listDto = list.stream().map(obj -> new ClienteDTO(obj)).collect(Collectors.toList()); // converte a lista Cliente para uma lista Cliente DTO
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> listDto = list.map(obj -> new ClienteDTO(obj)); // converte a page Cliente para a Page Cliente DTO
		return ResponseEntity.ok().body(listDto);
	}
